...
INSERT INTO car (cno, pname, ent, ent_time, "check", exit_time, ptime, disc)
VALUES
    ('123가5678', 'Owner-1', 'Entrance-1', '2024-05-01 08:00:00', 'Check-1', '2024-05-01 09:00:00', strftime('%H:%M:%S', '2024-05-01 09:00:00', '-' || strftime('%s', '2024-05-01 08:00:00') || ' seconds'), 'Discount-1'),
    ('234라1234', 'Owner-2', 'Entrance-2', '2024-05-01 09:00:00', 'Check-2', '2024-05-01 10:00:00', strftime('%H:%M:%S', '2024-05-01 10:00:00', '-' || strftime('%s', '2024-05-01 09:00:00') || ' seconds'), 'Discount-2'),
    ('345마2345', 'Owner-3', 'Entrance-3', '2024-05-01 10:00:00', 'Check-3', '2024-05-01 11:00:00', strftime('%H:%M:%S', '2024-05-01 11:00:00', '-' || strftime('%s', '2024-05-01 10:00:00') || ' seconds'), 'Discount-3'),
    ('456바3456', 'Owner-4', 'Entrance-4', '2024-05-01 11:00:00', 'Check-4', '2024-05-01 12:00:00', strftime('%H:%M:%S', '2024-05-01 12:00:00', '-' || strftime('%s', '2024-05-01 11:00:00') || ' seconds'), 'Discount-4'),
    ('567나4567', 'Owner-5', 'Entrance-5', '2024-05-01 12:00:00', 'Check-5', '2024-05-01 13:00:00', strftime('%H:%M:%S', '2024-05-01 13:00:00', '-' || strftime('%s', '2024-05-01 12:00:00') || ' seconds'), 'Discount-5'),
    ('678다5678', 'Owner-6', 'Entrance-6', '2024-05-01 13:00:00', 'Check-6', '2024-05-01 14:00:00', strftime('%H:%M:%S', '2024-05-01 14:00:00', '-' || strftime('%s', '2024-05-01 13:00:00') || ' seconds'), 'Discount-6'),
    ('789아6789', 'Owner-7', 'Entrance-7', '2024-05-01 14:00:00', 'Check-7', '2024-05-01 15:00:00', strftime('%H:%M:%S', '2024-05-01 15:00:00', '-' || strftime('%s', '2024-05-01 14:00:00') || ' seconds'), 'Discount-7'),
    ('890사7890', 'Owner-8', 'Entrance-8', '2024-05-01 15:00:00', 'Check-8', '2024-05-01 16:00:00', strftime('%H:%M:%S', '2024-05-01 16:00:00', '-' || strftime('%s', '2024-05-01 15:00:00') || ' seconds'), 'Discount-8'),
    ('901자8901', 'Owner-9', 'Entrance-9', '2024-05-01 16:00:00', 'Check-9', '2024-05-01 17:00:00', strftime('%H:%M:%S', '2024-05-01 17:00:00', '-' || strftime('%s', '2024-05-01 16:00:00') || ' seconds'), 'Discount-9'),
    ('012하9012', 'Owner-10', 'Entrance-10', '2024-05-01 17:00:00', 'Check-10', '2024-05-01 18:00:00', strftime('%H:%M:%S', '2024-05-01 18:00:00', '-' || strftime('%s', '2024-05-01 17:00:00') || ' seconds'), 'Discount-10');
